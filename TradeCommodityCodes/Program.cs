using TradeCommodityCodes.Example.Endpoints;
using TradeCommodityCodes.Example.Services;
using TradeCommodityCodes.Utils;
using TradeCommodityCodes.Utils.Http;
using TradeCommodityCodes.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using TradeCommodityCodes.Config;
using TradeCommodityCodes.Utils.Logging;
using Serilog;
